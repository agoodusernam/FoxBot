...
async def rob_success(ctx: CContext, profile: Profile, target: discord.Member, target_profile: Profile) -> None:
...
async def rob_success_og(ctx: CContext, profile: Profile, target: discord.Member, target_profile: Profile) -> None:
    await ctx.send(f"You successfully robbed {target.display_name} and stole some money!")
...
async def got_shot(ctx: CContext, profile: Profile, target: discord.Member) -> None:
